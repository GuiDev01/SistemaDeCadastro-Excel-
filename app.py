...
class App(ctk.CTk):
    ...
    def todo_sistema(self):
        ...
        title = ctk.CTkLabel(frame, text="Sistema de Gestão de Clientes", font=("Century Gohtic bold", 24),
        ...
        text_color=["#000", "#fff"])
        lb_contact = ctk.CTkLabel(self, text="Contato", font=("Century Gothic bold", 16),
        text_color=["#000", "#fff"])
        lb_age = ctk.CTkLabel(self, text="Idade", font=("Century Gothic bold", 16),
        text_color=["#000", "#fff"])
        lb_gender = ctk.CTkLabel(self, text="Género", font=("Century Gothic bold", 16),
        text_color=["#000", "#fff"])
